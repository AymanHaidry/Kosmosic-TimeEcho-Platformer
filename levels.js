...
// ━━ LEVEL 6 — "The Frozen Gauntlet" ━━ icy platforms, wisps
{
  ...
  spikes:[], pressurePlates:[], lasers:[], lava:[],
...
// ━━ LEVEL 8 — "The Pressure Chamber" ━━ pressure plates, multi-echo
{
  ...
  platforms:[
    ...
    lavaRiver(180,90,600),
    plat(270,460,120,16),
    lavaRiver(390,90,600),
    plat(480,380,110,16),
    lavaRiver(590,90,600),
    plat(680,440,110,16),
    lavaRiver(790,90,600),
    plat(880,360,120,16),
    lavaRiver(1000,90,600),
    plat(1090,440,120,16),
    lavaRiver(1210,90,600),
    plat(1300,360,100,16),
    lavaRiver(1400,90,600),
    plat(1490,440,120,16),
    movPlat(1650,360,90,'x',90,1.3),
    lavaRiver(1740,90,600),
    plat(1830,440,130,16),
    lavaRiver(1960,90,600),
    plat(2050,360,110,16),
    movPlat(2200,300,90,'y',70,1.1),
    lavaRiver(2290,90,600),
    plat(2380,440,120,16),
    lavaRiver(2500,90,600),
...
// ━━ LEVEL 9 — "Void Stalker" ━━ VoidShades introduced, night
{
  ...
  platforms:[
    plat(0,580,180,40),
    lavaRiver(180,90,620),
    plat(270,480,110,16),
    lavaRiver(380,90,620),
    plat(470,420,110,16),
    lavaRiver(580,90,620),
    plat(670,360,110,16),
    lavaRiver(780,90,620),
    plat(870,460,110,16),
    lavaRiver(980,90,620),
    plat(1070,380,110,16),
    lavaRiver(1180,90,620),
    plat(1270,460,110,16),
    lavaRiver(1380,90,620),
    plat(1470,360,120,16),
    movPlat(1640,420,90,'x',90,1.3),
    lavaRiver(1730,90,620),
    plat(1820,460,110,16),
    lavaRiver(1930,90,620),
    plat(2020,360,110,16),
    movPlat(2170,440,90,'y',60,1.1),
    lavaRiver(2260,90,620),
    plat(2350,460,110,16),
    lavaRiver(2460,90,620),
    plat(2550,360,110,16),
    lavaRiver(2660,90,620),
    plat(2750,460,120,16),
    lavaRiver(2870,90,620),
